...
def Infos_system(event=None):
    import infos_system    

def Reports_(event=None):
    import Reports
...
# -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
Suporte = Button(Windows, text="SUPORTE", background=Cinza_Novo, foreground=Branco, font=Fonte_teste,
                     activebackground=Cinza_Novo, activeforeground=Branco,border=0,command=Infos_system)
...
Relatorios.menu.add_command(label='Histórico', font=Fonte_teste, background=Cinza_Novo, activebackground=Cinza40, command=Reports_)
# ---------------------------------------------------------------------------------------------------------------------
# ---------------------------------------------------------------------------------------------------------------------
...
Arquivo.menu.add_command(label="FORNECEDOR", font=Fonte_teste, background=Cinza_Novo, activebackground=Cinza40,
                         command=lambda:Register_Industry())
